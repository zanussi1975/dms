...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:tns="http://crd.gov.pl/wzor/2025/06/25/13775/" version="1.0" exclude-result-prefixes="tns">
            ...
            <thead>
              <tr>
                ...
                <xsl:if test="tns:Fa/tns:FaWiersz/tns:P_8A">
                  <th class="table-basic__header">Miara</th>
                </xsl:if>
                <xsl:if test="$P_10 = '1'">
  ...
  <xsl:template name="Platnosc">
    <xsl:if test="tns:Fa/tns:Platnosc">
      <div class="section-data">
        ...
        <xsl:if test="tns:Fa/tns:Platnosc/tns:Zaplacono = '1' or tns:Fa/tns:Platnosc/tns:ZnacznikZaplatyCzesciowej">
          <span class="label-data-info">
            ...
            <span class="label-data-info--value">
              <xsl:choose>
                ...
                <xsl:when test="tns:Fa/tns:Platnosc/tns:ZnacznikZaplatyCzesciowej = '2'">
                 <xsl:text>Zapłacono całość w częściach</xsl:text>
                </xsl:when>                
              </xsl:choose>
            </span>
          </span>
        ...
        <xsl:if test="tns:Fa/tns:Platnosc/tns:ZnacznikZaplatyCzesciowej or tns:Fa/tns:Platnosc/tns:TerminPlatnosci">
          <div class="section-data">
            <xsl:if test="tns:Fa/tns:Platnosc/tns:ZnacznikZaplatyCzesciowej">
              <div class="section-data__wrapper-left">
                <div class="keep-together to-left to-left--with-margin">
                  <table class="table-basic table-basic--wide">
                    <thead>
                    ...
                    <tbody>
                      <xsl:for-each select="tns:Fa/tns:Platnosc/tns:ZaplataCzesciowa">
                        <tr>
                          ...
                          <xsl:if test="//tns:Fa/tns:Platnosc/tns:ZaplataCzesciowa/tns:FormaPlatnosci or //tns:Fa/tns:Platnosc/tns:ZaplataCzesciowa/tns:PlatnoscInna = '1'">
                            <td class="table-basic__cell table-basic__cell--to-right">                            
                              <xsl:choose>
            ...
            <xsl:if test="tns:Fa/tns:Platnosc/tns:TerminPlatnosci">
              <xsl:variable name="WrapperPla">
                <xsl:choose>
                  <xsl:when test="tns:Fa/tns:Platnosc/tns:ZnacznikZaplatyCzesciowej"><xsl:value-of select="'section-data__wrapper-right'"/></xsl:when>
                  <xsl:otherwise><xsl:value-of select="'section-data__wrapper-left'"/></xsl:otherwise>
                </xsl:choose>
              </xsl:variable>
              <xsl:variable name="KeepTogetherPla">
                <xsl:choose>
                  <xsl:when test="tns:Fa/tns:Platnosc/tns:ZnacznikZaplatyCzesciowej"><xsl:value-of select="'keep-together to-right to-right--with-margin'"/></xsl:when>
                  <xsl:otherwise><xsl:value-of select="'keep-together to-left to-left--with-margin'"/></xsl:otherwise>
                </xsl:choose>
              </xsl:variable>
                    ...
                    <thead>
                      <tr>
                        ...
                        <xsl:if test="tns:Fa/tns:Platnosc/tns:TerminPlatnosci/tns:TerminOpis">
                          <th class="table-basic__header">Opis terminu płatności</th>
                        </xsl:if>
                      </tr>
                    </thead>
                    <tbody>
                      <xsl:for-each select="tns:Fa/tns:Platnosc/tns:TerminPlatnosci">
                        <tr>
                          ...
                          <xsl:if test="//tns:Fa/tns:Platnosc/tns:TerminPlatnosci/tns:TerminOpis">
                            <td class="table-basic__cell"><xsl:value-of select="tns:TerminOpis/tns:Ilosc"/>&#160;<xsl:value-of select="tns:TerminOpis/tns:Jednostka"/>&#160;<xsl:value-of select="tns:TerminOpis/tns:ZdarzeniePoczatkowe"/></td>
                          </xsl:if>
                        </tr>
                      </xsl:for-each>
                    </tbody>
      ...
      <xsl:if test="tns:Fa/tns:Platnosc/tns:LinkDoPlatnosci | tns:Fa/tns:Platnosc/tns:IPKSeF">
        <div class="section-data">      
          <xsl:if test="tns:Fa/tns:Platnosc/tns:LinkDoPlatnosci">        
            <span class="label-data-info">
              <span class="label-data-info--name">Link do płatności bezgotówkowej: </span>
              <span class="label-data-info--value"><xsl:value-of select="tns:Fa/tns:Platnosc/tns:LinkDoPlatnosci"/></span>
            </span>
          </xsl:if>
          <xsl:if test="tns:Fa/tns:Platnosc/tns:IPKSeF">
            <span class="label-data-info">
              <span class="label-data-info--name">Identyfikator płatności Krajowego Systemu e-Faktur: </span>
              <span class="label-data-info--value"><xsl:value-of select="tns:Fa/tns:Platnosc/tns:IPKSeF"/></span>
            </span>
          </xsl:if>
        </div>
      </xsl:if>                            
